...
energy <- subset(energyvibes, select = -c(apparentTemperatureHighTime,
                                         ...
                                         apparentTemperatureMin, temperatureHighTime, 
                                          temperatureLowTime, energy_std, LCLid))
```
...
energy_corr <- energy_corr[, -c(1, 16)]
...
# Energy count was removed because the only values in that column is 48
...
numeric.df = energy_clean %>% 
  select(visibility, windBearing, 
         ...
         energy_count, energy_sum, energy_min, moonPhase, temperatureMax, dewPoint)
...
PC1 explains 31% of the variation, PC2 = 22%, PC3 = 11%, PC4 = 9% and PC5 = 7%. 80% of total variance of this data set can be explained by the first 5 PC loadings.
